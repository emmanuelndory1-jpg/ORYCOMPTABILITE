    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex transition-colors duration-300">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-slate-900 dark:bg-black relative overflow-hidden flex-col justify-between p-12 text-white">
        ...
        <div className="absolute inset-0 z-0 opacity-20">
          <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_50%_50%,_var(--color-brand-green)_0%,_transparent_50%)] scale-150" />
          <div className="absolute bottom-0 right-0 w-full h-full bg-[radial-gradient(circle_at_80%_80%,_#3b82f6_0%,_transparent_50%)] scale-150" />
        </div>
        ...
        <div className="relative z-10 max-w-lg">
          ...
          >
            La gestion comptable simplifiée pour l'espace <span className="text-brand-gold">OHADA</span>.
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Pilotez votre entreprise avec précision, conformité et sérénité. Rejoignez des milliers d'entrepreneurs qui nous font confiance.
          </motion.p>
          ...
          >
            {[
              ...
              "Gestion multi-devises (XOF, XAF, EUR)",
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white dark:bg-slate-900 transition-colors duration-300">
        <div className="w-full max-w-md space-y-8">
          <div className="text-center lg:text-left">
            ...
            <p className="text-slate-500 dark:text-slate-400 mt-2">Connectez-vous pour accéder à votre espace.</p>
          </div>
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-white dark:bg-slate-900 text-slate-500 dark:text-slate-400">Ou avec vos identifiants</span>
                </div>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <a href="#" className="text-sm font-medium text-brand-green hover:text-brand-green-light hover:underline">
                    Mot de passe oublié ?
                  </a>
                </div>
                <div className="relative group">
              ...
              <div className="flex items-center gap-2">
                <input 
                  type="checkbox" 
                  id="remember" 
                  className="w-4 h-4 rounded border-slate-300 dark:border-slate-700 text-brand-green focus:ring-brand-green bg-white dark:bg-slate-800"
                />
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-4 bg-brand-green text-white rounded-xl font-bold text-lg hover:bg-brand-green-light hover:shadow-lg hover:shadow-brand-green/20 active:scale-[0.98] transition-all flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
              >
                {loading ? (
                  <Loader2 className="animate-spin" />
                ) : (
            ...
            <div className="mt-8 pt-6 border-t border-slate-100 dark:border-slate-800 text-center">
              <p className="text-slate-500 dark:text-slate-400 text-sm">
                ...
                <Link to="/register" className="font-bold text-brand-green hover:text-brand-green-light hover:underline">
                  Créer un compte gratuitement
                </Link>
              </p>
            </div>

            <div className="mt-8 bg-slate-50 dark:bg-slate-800/50 p-4 rounded-xl border border-slate-100 dark:border-slate-800 text-center">
              <p className="text-xs font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-2">Compte de démonstration</p>
              <div className="flex justify-center gap-4 text-sm font-mono text-slate-700 dark:text-slate-300">
                <span className="bg-white dark:bg-slate-800 px-2 py-1 rounded border border-slate-200 dark:border-slate-700">admin@example.com</span>
                <span className="bg-white dark:bg-slate-800 px-2 py-1 rounded border border-slate-200 dark:border-slate-700">admin123</span>
              </div>
              </div>
            </div>
          </motion.div>
