...
export function AssetsManager() {
  ...
  const [prorataTemporis, setProrataTemporis] = useState(true);
    ...
    try {
      const res = await apiFetch('/api/assets', {
        ...
        body: JSON.stringify({
          ...
          prorata_temporis: prorataTemporis,
          ...
          <div className="p-6 grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="col-span-2 flex items-center justify-between p-3 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50">
                  <div>
                    <h4 className="text-sm font-semibold text-slate-900 dark:text-white">Prorata Temporis</h4>
                    <p className="text-xs text-slate-500 dark:text-slate-400">Calculer la première annuité en fonction de la date d'acquisition</p>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input type="checkbox" className="sr-only peer" checked={prorataTemporis} onChange={e => setProrataTemporis(e.target.checked)} />
                    <div className="w-11 h-6 bg-slate-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-brand-green/20 dark:peer-focus:ring-brand-green/20 rounded-full peer dark:bg-slate-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-slate-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-slate-600 peer-checked:bg-brand-green"></div>
                  </label>
                </div>
